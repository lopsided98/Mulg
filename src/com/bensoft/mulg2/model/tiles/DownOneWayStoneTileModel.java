 ...
 */
public class DownOneWayStoneTileModel extends OneWayStoneTileModel {

    public DownOneWayStoneTileModel(Level level, float x, float y, int data) {
        super(level, x, y, data, new SimpleTileView(8));
    }
