 ...
 */
public class LeftOneWayStoneTileModel extends OneWayStoneTileModel {

    public LeftOneWayStoneTileModel(Level level, float x, float y, int data) {
        super(level, x, y, data, new SimpleTileView(9));
    }
